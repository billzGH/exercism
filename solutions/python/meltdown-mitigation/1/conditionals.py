...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    lower_bound = threshold - (0.10 * threshold)
    upper_bound = threshold + (0.10 * threshold)
    
    if temperature * neutrons_produced_per_second < 0.9 * threshold:
        return "LOW"
    if temperature * neutrons_produced_per_second >= lower_bound and temperature * neutrons_produced_per_second <= upper_bound:
        return "NORMAL"
    else:
        return "DANGER"
